...
export const Hero = () => {
    return (
        <div className='text-[#f1f1f1] max-w-[1240px] h-screen mx-auto grid md:grid-cols-2'>

            <div className='w-full  flex flex-col p-4 text-center justify-center'>
              
                    
                    <h1 className=' text-[#f1f1f1] md:text-6xl sm:text-4xl text-4xl font-bold md:py-6 my-3 text-opacity-85'>Creating bugs since 2021</h1>

                    <div className='text-[#3368fa] flex justify-center items-center my-3'>
                    ...
                    <div className="flex md:flex-row flex-col mx-auto text-lg gap-x-4 my-3">
                        ...
                        <a href='../../cv-es.pdf' download  className='bg-[#3368fa] w-[150px] rounded-md font-medium my-6 mx-auto py-3 text-[#f1f1f1] hover:cursor-pointer hover:scale-105 duration-300 flex justify-center ' ><FaFilePdf size={30} className='mx-1' /><span className='mx-1'> Resume</span></a>
                    </div>

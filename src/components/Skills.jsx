...
export const Skills = () => {
    return (
        ...
        <div className="text-[#f1f1f1] max-w-[1240px] h-screen mx-auto">
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 justify-center items-center text-center my-10 gap-y-10 mt-[12rem] text-slate-300'>
                ...
                <div className='flex flex-col justify-center items-center hover:scale-105 duration-300 gap-y-2 '><FaDatabase  size={70} className=' hover:text-[#485aff] transition-colors duration-300' />SQL</div>
            </div>
        </div>
    )
}
